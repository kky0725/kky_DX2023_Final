...
public:
	...
	void SetNumberEvent(CallBack numberEvent, int eventNumer) { _numberEvent = numberEvent; _eventNumber = eventNumer; }
	void SetAlmostEnd(CallBack event) { _almostEnd = event; }
